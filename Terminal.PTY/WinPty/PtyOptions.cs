...
namespace Terminal.PTY.WinPty
{
	...
	public class PtyOptions
	{
		...
		///     <c>false</c>, the default, means that the arguments must be quoted and quotes inside escaped then concatenated with
		///     spaces.
		...
		/// <summary>
		///     Gets or sets a value indicating whether WinPty should be forced as the windows backend even on systems where ConPty
		///     is available.
		/// </summary>
